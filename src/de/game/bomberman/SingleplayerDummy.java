...
/**
 * Das ist die Schnittstelle aller Klassen. Die Klasse SingleplayerDummy ruft hier von allen Klassen Konstruktoren und Methoden auf.
 ...
 * Anders als bei der RandomMap und StaticMap, spielt der Spieler hier alleine die Maps. Diese Maps sind Static, dh auch bei Neustarten gleichbleibend.
 ...
 * Hier findet die Abfrage statt, wenn der Spieler nicht mehr vorhanden ist --> SpielEnde. Die Explosionsgroesse und -zeit wird hier gesetzt.
...
public class SingleplayerDummy extends BasicGameState {
  ...
  /**
   * Die Explosion ist im Spiel die Moeglichkeit die zerstoerbaren Bloecke und den Gegner auszuschalten
   * und zu entfernen.
